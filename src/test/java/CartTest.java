...
public class CartTest {
    ...
    public void verifyTotalPrice() throws InterruptedException {
        ...
        // Pronađi sve redove u tabeli korpe
        ...
        for (int i = 0; i < rows.size(); i++) {
            ...
            try {
                ...
                if (quantityElements.isEmpty()) {
                    ...
                    continue; // Preskoči ako nema količine
                }
        ...
        // Zaokruži oba rezultata na 2 decimale
    ...
    public void processPayment() throws InterruptedException {
        ...
        /*
        WebElement continueButton = webDriver.findElement(By.xpath(""));
